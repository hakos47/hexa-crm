...
try {
  ...
  await sql.unsafe(`GRANT SELECT, INSERT, UPDATE, DELETE ON products, customers, sales, sale_lines, cash_movements, reservations, reservation_lines, orders, order_lines, external_customer_identities, semantic_documents, semantic_metrics, idempotency_keys, service_request_replays, service_audit_log, tenant_plugins, plugin_audit_log TO ${user}`);
