...
try {
  ...
  await sql.unsafe(`GRANT SELECT, INSERT, UPDATE, DELETE ON products, customers, sales, cash_movements, reservations, reservation_lines, external_customer_identities, semantic_documents, idempotency_keys, service_request_replays, service_audit_log TO ${user}`);
